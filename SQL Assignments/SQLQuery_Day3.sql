...
--7- your manager handles the sales for South region and he wants you to create a report of 
...
--9- write a query to find all the records in technology and furniture category for the orders placed in the 
--year 2020 only (1021 rows)
